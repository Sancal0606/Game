...
public class Wall {
    ...
    public void checkCollision(){
       ...
       if((game.p1.positionX+(game.p1.horzMove*game.p1.speed)+52>posX&&
               game.p1.positionX+(game.p1.horzMove*game.p1.speed)+12<posX+sizeX)&&
               (game.p1.positionY+(game.p1.vertMove*game.p1.speed)+52>posY)&&
               (game.p1.positionY+(game.p1.vertMove*game.p1.speed)+12<posY+sizeY)){
    ...
    public void enemyWall(){
        if(game.enemy.x+game.enemy.xa+58>posX&&
               game.enemy.x+game.enemy.xa+6<posX+sizeX&&
               game.enemy.y+game.enemy.ya+58>posY&&
           ...
           if(game.enemy.ya>0){
            ...
            if(game.enemy.y+game.enemy.ya<posY-12+64&&game.enemy.x+game.enemy.xa+58>posX&&
               game.enemy.x+game.enemy.xa+6<posX+sizeX ){
               game.enemy.notYUp=true;
           }else
                game.enemy.notYUp=false;
            if(game.enemy.y+game.enemy.ya+58>posY+12&&game.enemy.x+game.enemy.xa+58>posX&&
               game.enemy.x+game.enemy.xa+6<posX+sizeX)
    ...
    public void enemy2Wall(){
        if(game.enemy2.x+game.enemy2.xa+58>posX&&
               game.enemy2.x+game.enemy2.xa+6<posX+sizeX&&
               game.enemy2.y+game.enemy2.ya+58>posY&&
           ...
           if(game.enemy2.y+game.enemy2.ya<posY-12+64&&game.enemy2.x+game.enemy2.xa+58>posX&&
               game.enemy2.x+game.enemy2.xa+6<posX+sizeX ){
               game.enemy2.notYUp=true;
           }else
                game.enemy2.notYUp=false;
            if(game.enemy2.y+game.enemy2.ya+58>posY+12&&game.enemy2.x+game.enemy2.xa+58>posX&&
               game.enemy2.x+game.enemy2.xa+6<posX+sizeX)
